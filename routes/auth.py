...
from db import Usuario, session as db_session
...
@login_required
def usuario():
    return render_template('Paginadeusuario.html', nome=session.get('user_nome'))
...
def register():
    ...
    if form.validate_on_submit():
        ...
        usuario = Usuario(nome=nome, email=email, senhacript=criptografarsenha(senha))
